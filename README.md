...
[![CI](https://github.com/Oefenweb/ansible-new-relic-servers/workflows/CI/badge.svg)](https://github.com/Oefenweb/ansible-new-relic-servers/actions?query=workflow%3ACI)
...
* `new_relic_servers_logfile`: [optional, default `/var/log/newrelic/nrsysmond.log`]: Name of the file where the server monitor will store its log message
...
* `new_relic_servers_pidfile`: [optional, default `/var/run/newrelic/nrsysmond.pid`]: Name of a file where the server monitoring daemon will store its process ID (PID)
